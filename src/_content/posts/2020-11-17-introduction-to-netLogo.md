...
In this post, I'm going to introduce NetLogo and show you how to write a simple program that has a surprise. I won't show the result, so you'll need to download the software and try it yourself.
