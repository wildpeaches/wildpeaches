...
lede: 
hero:
  url: /assets/img/co2-v-ch4/co2-v-ch4.png
  alt:
tags: [math]
keywords: []
socialImg: /assets/img/co2-v-ch4/co2-v-ch4.png
---
...
![reply-hazy](/assets/img/co2-v-ch4/reply-hazy.jpg)
...
![Fuel Carbon-Hydrogen Ratio](/assets/img/co2-v-ch4/fuel-carbon-hydrogen-ratio.jpg)
...
![atmospheric-gases-concentrations](/assets/img/co2-v-ch4/atmospheric-gases-concentrations.png)

There's still plenty to breathe, but the drop is quite noticeable in the plot.

![gas-mask](/assets/img/co2-v-ch4/gas-mask.png)
...
![GlobalEnergyBudget](/assets/img/co2-v-ch4/GlobalEnergyBudget.png)
...
![single-layer-model](/assets/img/co2-v-ch4/single-layer-model.png)
...
![single-layer-model-emissivity](/assets/img/co2-v-ch4/single-layer-model-emissivity.png)
...
![smath-solver-earth-temperature](/assets/img/co2-v-ch4/smath-solver-earth-temperature.png)
...
For help with SMath Studio, look at the [wiki](https://en.smath.com/wiki/), the [forum](https://en.smath.com/forum/), or ["Of Sailing Ships, Velociraptors, and Walking on the Moon"](https://wildpeaches.xyz/blog/of-sailing-ships-velociraptors-and-walking-on-the-moon/).
...
![ch4-gwp-gtp](/assets/img/co2-v-ch4/ch4-gwp-gtp.gif)
...
![ch4-relative-impact](/assets/img/co2-v-ch4/ch4-relative-impact.gif)
...
![magic-eight-ball-outlook-not-so-good-photo-researchers-inc](/assets/img/co2-v-ch4/magic-eight-ball-outlook-not-so-good-photo-researchers-inc.jpg)
