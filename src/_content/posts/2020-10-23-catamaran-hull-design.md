...
![Great Eastern 1866](/assets/img/catamaran-hull-design/great-eastern-1866.svg){.mx-auto}
...
![Side view](/assets/img/catamaran-hull-design/side-view.svg){.mx-auto}

In SMath Studio you can enter values for total length and waterline length like this:

![SMath Studio length parameters](/assets/img/catamaran-hull-design/smath-studio-length-parameters.svg){.mx-auto}
...
![Smath Studio length unit entry](/assets/img/catamaran-hull-design/smath-studio-length-unit-entry.svg){.mx-auto}
...
![SMath Studio text color](/assets/img/catamaran-hull-design/smath-studio-text-color.svg){.mx-auto}
...
![Single hull top view](/assets/img/catamaran-hull-design/Single hull top view.svg){.mx-auto}
...
$$
![Section view](/assets/img/catamaran-hull-design/section-view.svg){.mx-auto}
...
James Wharram designs catamarans meant to be cut from sheets of marine plywood with no rounded cross-sections, such as the Ariki shown here. Construction is simpler, but the midship coefficient is quite low.
 ...
 ![Ariki](/assets/img/catamaran-hull-design/Ariki.svg){.mx-auto}
...
![ellipse](/assets/img/catamaran-hull-design/ellipse.svg){.mx-auto}
...
![Waterplane coefficient](/assets/img/catamaran-hull-design/waterplane-coefficient.svg){.mx-auto}
...
$$
 ...
 ![Two hulls top view](/assets/img/catamaran-hull-design/Two hulls top view.svg){.mx-auto}
...
![SMath Studio design parameters](/assets/img/catamaran-hull-design/smath-studio-design-parameters.svg){.mx-auto}
...
![SMath Studio derived parameters](/assets/img/catamaran-hull-design/smath-studio-derived-parameters.svg){.mx-auto}
...
![Resistance and powering of ships](/assets/img/catamaran-hull-design/resistance-and-powering-of-ships.bmp){.mx-auto}
...
![Optimal aspect ratios for ship hulls](/assets/img/catamaran-hull-design/optimal-aspect-ratios-for-ship-hulls.bmp){.mx-auto}
...
![Wavelength vs speed](/assets/img/catamaran-hull-design/wavelength-vs-speed.bmp){.mx-auto}
...
![Velociraptors](/assets/img/catamaran-hull-design/velociraptors.bmp){.mx-auto}
...
![Vicious velociraptor](/assets/img/catamaran-hull-design/vicious-velociraptor.bmp){.mx-auto}
